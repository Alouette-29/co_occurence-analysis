...
if __name__ == "__main__":
    ...
    for i in range(5):
        ...
        co_dict = {"idx": f"第{i + 1}部"}
        co_matrices.append(co_matrix.tolist())
        freq_matrices.append(freq_matrix.tolist())
    
    if not os.path.exists("output"):
        os.makedirs("output")
    
    with open("output/co_matrices.json", "w", encoding="utf-8") as f:
        json.dump(co_matrices, f)
    with open("output/freq_matrices.json", "w", encoding="utf-8") as f:
        json.dump(freq_matrices, f)
